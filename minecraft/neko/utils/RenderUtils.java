...
public class RenderUtils
{
    ...
    public static void drawRoundedRect(double binaruba, double analuvar, double navoyope, double amezefep, double umitanes, int icofutam) {
        float var11 = (float)(icofutam >> 24 & 255) / 255.0F;
        float var12 = (float)(icofutam >> 16 & 255) / 255.0F;
        float var13 = (float)(icofutam >> 8 & 255) / 255.0F;
        float var14 = (float)(icofutam & 255) / 255.0F;
        GL11.glPushAttrib(0);
        ...
        for(var15 = 0; var15 <= 90; var15 += 3) {
            GL11.glVertex2d(binaruba + umitanes + Math.sin((double)var15 * 3.141592653589793D / 180.0D) * umitanes * -1.0D, analuvar + umitanes + Math.cos((double)var15 * 3.141592653589793D / 180.0D) * umitanes * -1.0D);
        }

        for(var15 = 90; var15 <= 180; var15 += 3) {
            GL11.glVertex2d(binaruba + umitanes + Math.sin((double)var15 * 3.141592653589793D / 180.0D) * umitanes * -1.0D, amezefep - umitanes + Math.cos((double)var15 * 3.141592653589793D / 180.0D) * umitanes * -1.0D);
        }

        for(var15 = 0; var15 <= 90; var15 += 3) {
            GL11.glVertex2d(navoyope - umitanes + Math.sin((double)var15 * 3.141592653589793D / 180.0D) * umitanes, amezefep - umitanes + Math.cos((double)var15 * 3.141592653589793D / 180.0D) * umitanes);
        }

        for(var15 = 90; var15 <= 180; var15 += 3) {
            GL11.glVertex2d(navoyope - umitanes + Math.sin((double)var15 * 3.141592653589793D / 180.0D) * umitanes, analuvar + umitanes + Math.cos((double)var15 * 3.141592653589793D / 180.0D) * umitanes);
        }
    ...
    public static void glScissor(double edagured, double dedesaze, double leceyane, double var7) {
        dedesaze += var7;
        ScaledResolution var9 = new ScaledResolution(Minecraft.getMinecraft());
        Minecraft var10 = Minecraft.getMinecraft();
        GL11.glScissor((int)(edagured * (double)var10.displayWidth / (double)var9.getScaledWidth()), (int)(((double)var9.getScaledHeight() - dedesaze) * (double)var10.displayHeight / (double)var9.getScaledHeight()), (int)(leceyane * (double)var10.displayWidth / (double)var9.getScaledWidth()), (int)(var7 * (double)var10.displayHeight / (double)var9.getScaledHeight()));
    }

    public static void drawBorderedRoundedRect(float igelupov, float nacirati, float zonofuba, float esivodiv, float ilutogug, int zavutago, int idezevan) {
        drawRoundedRect((double)igelupov, (double)nacirati, (double)zonofuba, (double)esivodiv, (double)ilutogug, zavutago);
        drawRoundedRect((double)(igelupov + 0.5), (double)(nacirati + 0.5), (double)(zonofuba - 0.5), (double)(esivodiv - 0.5), (double)ilutogug, idezevan);
    }
