...
public class HUDConfigScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (IRenderer renderer : renderers.keySet()) {
            ...
            if (dragged) {
                Gui.INSTANCE.drawVerticalLine(mouseX, height, -height, 0x3BFFFFFF);
                Gui.INSTANCE.drawHorizontalLine(width, -width, mouseY, 0x3BFFFFFF);
            }
            ...
            if (this.hovered) {
                ...
                Gui.INSTANCE.drawHollowRect(pos.getAbsoluteX(), pos.getAbsoluteY(), renderer.getWidth(), renderer.getHeight(), 0x88FFFFFF);
                if (dragged) {
