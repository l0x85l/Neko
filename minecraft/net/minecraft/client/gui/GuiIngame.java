...
import neko.mod.impl.Bossbar;
import neko.mod.impl.Sidebar;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        ((RenderGuiEvent) EventSystem.getInstance(RenderGuiEvent.class)).fire(scaledresolution);
    ...
    {
        if(ModManager.getMod(Sidebar.class).getState()) {
            return;
        }
    ...
    {
        if(ModManager.getMod(Bossbar.class).getState()) {
            return;
        }
