...
public class ModelPlayer extends ModelBiped
{
    ...
    public ModelPlayer(float p_i46304_1_, boolean p_i46304_2_)
    {
        ...
        this.bipedCustomCape = new ModelRenderer(this, 0, 0);
        this.bipedCustomCape.setTextureSize(22, 17);
        this.bipedCustomCape.addBox(-5.0F, 0.0F, -1.0F, 10, 16, 1, p_i46304_1_);
    ...
    public void renderCustomCape(float p_178728_1_)
    {
        this.bipedCustomCape.render(p_178728_1_);
    }
    ...
    public void setInvisible(boolean invisible)
    {
        ...
        this.bipedCustomCape.showModel = invisible;
