...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void updateRenderer()
    {
        ...
        {
            float f = this.mc.gameSettings.mouseSensitivity * 1F;
            float f1 = f * f * f * 8.0F;
            this.smoothCamFilterX = this.mouseFilterXAxis.smooth(this.smoothCamYaw, 0.09F * f1);
            this.smoothCamFilterY = this.mouseFilterYAxis.smooth(this.smoothCamPitch, 0.09F * f1);
